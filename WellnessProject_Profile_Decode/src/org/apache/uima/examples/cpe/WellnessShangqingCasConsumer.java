...
public class WellnessShangqingCasConsumer extends CasConsumer_ImplBase implements CasObjectProcessor {
  File outFile;
  File outFile2;
  ...
  public WellnessShangqingCasConsumer() {
  }
  ...
  public void initialize() throws ResourceInitializationException {
    ...
    String oPath2 = (String) getUimaContext().getConfigParameterValue("outputFile2");

    // Output file should be specified in the descriptor
    if (oPath == null ||oPath2 ==null) {
  ...
  public synchronized void processCas(CAS aCAS) throws ResourceProcessException {
    ...
    QuestionFactory qf =new QuestionFactory(fileWriter);
    ...
    while (annotationIter.hasNext()) {
      ...
      String annottype=annot.getType().getName();
      // System.out.println( annot.getType().getName() + " "+aText);
      try {
		qf.process(annottype,aText);
